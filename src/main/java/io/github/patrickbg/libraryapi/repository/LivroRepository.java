...
public interface LivroRepository extends JpaRepository<Livro, UUID> {
    ...
    // JPQL -> referencia as entidades e as suas propriedades
    //Comando abaixo em SQL = select l.* from livro as l order by l.titulo, l.preco
...
""")
    ...
    //  positional parameters -> parametros numerados
